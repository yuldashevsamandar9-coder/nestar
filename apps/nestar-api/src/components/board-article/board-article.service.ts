...
export class BoardArticleService {
	...
	public async getBoardArticle(memberId: Types.ObjectId, articleId: Types.ObjectId): Promise<BoardArticle> {
		...
		// meLiked
		const likeInput = { memberId: memberId as any, likeRefId: articleId as any, likeGroup: LikeGroup.ARTICLE };
	...
	public async likeTargetArticle(memberId: Types.ObjectId, likeRefId: Types.ObjectId): Promise<BoardArticle> {
